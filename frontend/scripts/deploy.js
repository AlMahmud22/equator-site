...
async function deployToProduction() {
  try {
    ...
    console.log('- View logs: pm2 logs equators-production');
    console.log('- Restart app: pm2 restart equators-production');
    console.log('- Stop app: pm2 stop equators-production');
    console.log('- Delete app: pm2 delete equators-production');
    console.log('');
