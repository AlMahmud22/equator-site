...
export const AUTH_CONFIG = {
  JWT: {
    SECRET: process.env.JWT_SECRET || "your-secret-jwt-key-equator-tech-needs-to-be-at-least-32-chars",
  ...
  ELECTRON: {
    PROTOCOLS: ["equatorchatbot", "equatorbrowser", "equatoraiplayground"],
    // Protocol for Electron app deep linking
    REDIRECT_PROTOCOL: "equator://auth/callback",
