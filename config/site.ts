...
export const projects = [
  // EXISTING PROJECTS - KEEP AS IS
  {
    ...
    `,
    icon: '🤖',
    image: '/images/latest/equator-chatbot.png',
    screenshots: [
    ...
    links: {
      ...
      demo: '/demo/chatbot',
      download: '/downloads/equator-chatbot/v2.1.0/',
    },
    downloads: {
      windows: '/downloads/equator-chatbot/v2.1.0/privacy-chatbot-setup.exe',
      mac: '/downloads/equator-chatbot/v2.1.0/privacy-chatbot.dmg',
      linux: '/downloads/equator-chatbot/v2.1.0/privacy-chatbot.AppImage',
    },
    version: '2.1.0',
  ...
  },
  {
    ...
    `,
    icon: '🌐',
    image: '/images/latest/equator browser.png',
    screenshots: [
    ...
    links: {
      ...
      demo: '/demo/browser',
      download: '/downloads/equator-browser/v3.2.1/',
    },
    downloads: {
      windows: '/downloads/equator-browser/v3.2.1/privacy-browser-setup.exe',
      mac: '/downloads/equator-browser/v3.2.1/privacy-browser.dmg',
      linux: '/downloads/equator-browser/v3.2.1/privacy-browser.AppImage',
    },
    version: '3.2.1',
    status: 'Production Ready',
  ...
  // NEW DESKTOP / CLI APPS
  {
    ...
    links: {
      ...
      demo: 'https://notes.equator.tech',
      download: 'https://notes.equator.tech',
    },
    downloads: {
      web: 'https://notes.equator.tech',
  ...
  // WEB APPS / WEB3 SECTION
  {
    ...
    links: {
      ...
      demo: 'https://swap.equator.tech',
      download: 'https://swap.equator.tech',
    },
    downloads: {
      web: 'https://swap.equator.tech',
    },
    version: '2.0.0',
  ...
  },
  {
    ...
    links: {
      ...
      demo: 'https://wallet.equator.tech',
      download: 'https://wallet.equator.tech',
    },
    downloads: {
      web: 'https://wallet.equator.tech',
    },
    version: '1.5.0',
    status: 'Production Ready',
