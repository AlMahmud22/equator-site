...
const mockModels: AIModel[] = [
  ...
  },
  {
    id: 'gpt-3.5-turbo',
    name: 'GPT-3.5 Turbo',
    description: 'A highly capable text generation model optimized for chat and general language tasks with excellent instruction following.',
    author: 'OpenAI',
    downloads: 450000,
    likes: 25600,
    tags: ['chat', 'instruction-following', 'text-generation'],
    modelType: 'text-generation',
    size: '7.2 GB',
  ...
  },
  {
    id: 'whisper-large',
    name: 'Whisper Large',
    description: 'State-of-the-art speech recognition model supporting multiple languages with high accuracy transcription capabilities.',
    author: 'OpenAI',
    downloads: 180000,
    likes: 14200,
