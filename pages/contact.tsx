...
export default function ContactPage() {
  ...
  return (
    <Layout
      title="Contact - equator"
      description="Get in touch about equator projects. Questions, feedback, or collaboration opportunities welcome."
    >
      <Head>
        <meta property="og:title" content="Contact - equator" />
        <meta property="og:description" content="Get in touch about equator projects. Questions, feedback, or collaboration opportunities welcome." />
            ...
            {[
              {
                ...
                contact: 'al.mahmud@equator.tech',
                action: 'Send Email',
                href: 'mailto:al.mahmud@equator.tech'
              },
              {
