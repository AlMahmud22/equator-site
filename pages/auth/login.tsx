...
export default function LoginPage() {
  ...
  return (
    <Layout
      title="Sign In or Sign Up - equator"
      description="Join equator community to access exclusive downloads and connect with cutting-edge tools"
    >
      <Head>
        <meta property="og:title" content="Join equator - Sign In or Sign Up" />
        ...
        <div className="max-w-md w-full space-y-8">
          ...
          >
            ...
            <h2 className="text-3xl font-bold text-white mb-2">
              Join <span className="text-gradient">equator</span>
            </h2>
