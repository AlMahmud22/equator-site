...
const ConsentPage: React.FC<ConsentPageProps> = ({
  ...
  return (
    <>
      <Head>
        <title>Authorize Application - equator</title>
        <meta name="description" content="Authorize application access to your equator account" />
      </Head>
        ...
        >
          ...
          <div className="text-center mb-6">
            ...
            <p className="text-gray-600 text-sm">
              {appData.description || 'This application is requesting access to your equator account.'}
            </p>
